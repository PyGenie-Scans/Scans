...
if "LARMOR" in host:  # pragma: no cover
    from .Larmor import scan, pol_measure, fast_pol_measure, detector_trans, specific_spectra  # noqa: F401
    _all += ["populate", "scan", "pol_measure", "fast_pol_measure", "detector_trans", "specific_spectra"]
