...
project = u'PyGenie Scans'
copyright = u'2018, Washington et al'
...
man_pages = [
    ('index', 'pygeniescans', u'PyGenie Scans Documentation',
     [u'Washington et al'], 1)
]
...
texinfo_documents = [
  ('index', 'PyGenieScans', u'PyGenie Scans Documentation',
   u'Washington et al', 'PyGenieScans', 'One line description of project.',
   'Miscellaneous'),
]
